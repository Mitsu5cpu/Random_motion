...
•The file named Random_collision.py takes every single input from user and considers collision from every particle.  
•⚠️ This Repository is still updating....🚧Work in Progress🚧.
